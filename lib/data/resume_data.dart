...
const experiences = <Experience>[
  Experience(
    ...
    challenges: [
      ...
      ResumeTextItem(
        ...
        links: [ResumeLink(label: 'Devin', url: 'https://devin.ai/')],
      ),
      ResumeTextItem(
  ...
  Experience(
    ...
    ingenuity: [ResumeTextItem('DroidKaigiの知見を活用した。')],
  ),
  Experience(
    id: 'dwango',
    employmentType: EmploymentType.contract,
...
const personalProjects = <PersonalProject>[
  PersonalProject(
    ...
    status: '公開中',
    tags: ['Flutter', 'Drift', 'Dio / Retrofit'],
  ...
  PersonalProject(
    ...
    status: '公開中',
    tags: ['Kotlin', 'Ktor 3.x', 'ktor-openapi-tools'],
  ...
  OutsideActivityGroup(
    ...
    items: [
      ...
      OutsideActivity(
        ...
        links: [ResumeLink(label: 'Zenn', url: 'https://zenn.dev/todayama_r')],
      ),
    ],
  ),
  OutsideActivityGroup(
