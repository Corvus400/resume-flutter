...
const personalProjects = <PersonalProject>[
  ...
  PersonalProject(
    ...
    repoUrl: 'https://github.com/Corvus400/fictional-drug-and-disease-ref-ios',
    repoLinkEnabled: false,
    status: '作成中',
    tags: <String>['Swift', 'SwiftUI', 'Xcode'],
  ),
  PersonalProject(
    name: 'resume-flutter',
    kind: 'Flutter Web',
  ...
  OutsideActivityGroup(
    ...
    items: <OutsideActivity>[
      OutsideActivity(
        ...
        detail: 'Claude Design 生成 HTML に検証ロジックを埋め込み実装との乖離を防ぐ',
        links: <ResumeLink>[
          ResumeLink(
            label: 'Zenn',
            url:
                'https://zenn.dev/todayama_r/articles/claude-design-self-verifying-html',
          ),
        ],
      ),
      OutsideActivity(
      ...
      OutsideActivity(
        ...
        links: <ResumeLink>[
          ResumeLink(
            label: 'Zenn',
            url:
                'https://zenn.dev/todayama_r/articles/multi-agent-secret-pii-guard-hooks',
          ),
        ],
      ),
      OutsideActivity(
